...
cd zlib-$ver
./configure --prefix=/home/runner/project/dists/zlib --static --libdir=/home/runner/project/dists/zlib/lib
make && make install
cd ..
...
cd pcre-$ver
./configure --prefix=/home/runner/project/dists/pcre --disable-shared --enable-utf8 --enable-unicode-properties
make && make install
cd ..
...
cd mbedtls-$ver
LDFLAGS=-static make DESTDIR=/home/runner/project/dists/mbedtls install
...
cd libsodium-$ver
./configure --prefix=/home/runner/project/dists/libsodium --disable-shared
make && make install
cd ..
...
cd libev-$ver
./configure --prefix=/home/runner/project/dists/libev --disable-shared
make && make install
cd ..
...
cd c-ares-$ver
./configure --prefix=/home/runner/project/dists/cares --disable-shared
make && make install 
cd ..
...
LIBS="-lpthread -lm" LDFLAGS="-Wl,-static -static -static-libgcc -L/home/runner/project/dists/libsodium/lib" CFLAGS="-I/home/runner/project/dists/libsodium/include" \
...
cp v2ray-plugin-linux /home/runner/project/dists/shadowsocks-libev/bin/v2ray-plugin
cd ..
...
cp ck-client-linux /home/runner/project/dists/shadowsocks-libev/bin/ck-client
cd ..
